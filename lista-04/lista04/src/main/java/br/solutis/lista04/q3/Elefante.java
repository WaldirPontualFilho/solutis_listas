...
public class Elefante extends AnimalTerrestreAB {
    ...
    public Elefante(String nome, String tipoAnimal, double altura, double peso, String habitat, int idade, int quantidadePatas) {
